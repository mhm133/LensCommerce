...
public class HorizontalDottedProgress extends LinearLayout {
    ...
    public HorizontalDottedProgress(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
